...
label_result= Label(root,width=25, height=2, text="", bg="#ffffcc", font=("arial",30))
label_result.pack()

Button(root,text="C", width=5, height=1, font=("arial",30, "bold"), bd=1,fg="#fff", bg= "#6666ff", command=lambda:clear()).place(x=10,y=100)
...
Button(root,text="=", width=5, height=3, font=("arial",30, "bold"), bd=1,fg="#fff", bg= "#b3b3ff", command=lambda:cal()).place(x=430,y=400)
